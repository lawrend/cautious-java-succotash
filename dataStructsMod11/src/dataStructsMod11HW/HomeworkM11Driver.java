...
//		System.out.println("queue1 firstNode 1:" + lq1.firstNode.data + " lastNode 6:" + lq1.lastNode.data + "   queue2 firstNode 3:" + lq2.firstNode.data + " lastNode 12:" + lq2.lastNode.data);
		...
		QueueInterface<Integer> q9 = new LinkedQueue<Integer>();
		q9.enqueue(1);
		q9.enqueue(4);
		q9.enqueue(2);
		q9.dequeue();
		q9.clear();
//		System.out.println(q9.firstNode == q9.lastNode);
		((LinkedQueue)q9).display();
...
//		QueueInterface newQueue = new LinkedQueue<>();  
