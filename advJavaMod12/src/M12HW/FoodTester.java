...
public class FoodTester {
	...
	public static void main(String[] args) {
		...
		BlockingQueue<Food> foodQueue = new ArrayBlockingQueue<>(3);
		Thread cooker = new Thread(new CookThread(foodQueue, foodList));  
		Thread server = new Thread(new ServeThread(foodQueue, foodList.size())); 
		cooker.start();
		server.start();
